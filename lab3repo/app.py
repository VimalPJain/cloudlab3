...
app.config['MYSQL_PASSWORD'] = 'redman57'
app.config['MYSQL_DB'] = 'studentbook'
app.config['MYSQL_HOST'] = '35.184.221.216'
mysql.init_app(app)
...
def add():
   ...
   cur.exucute('''INSERT INTO students(studentName,email) values ("new student", "newstudent@new.ie")''');
   cur.commit()
   rv = cur.fetchall()
   return str(rv)
